...
tmux_download(){
  ...
  DOWNLOAD https://github.com/libevent/libevent/releases/download/release-2.1.8-stable/libevent-2.1.8-stable.tar.gz libevent-2.1.8-stable.tar.gz
...
ptyjs(){
  ...
  "$NPM" install node-pty-prebuilt@0.7.6
